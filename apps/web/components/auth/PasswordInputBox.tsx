...
export default function PasswordInputBox({name, label, required, error, onChange}: PasswordInputBoxProps) {
        ...
        <div className="py-2">
            <div className="relative">
                <input 
                    ...
                    className={`block p-2 pt-3 pr-15 dark:text-gray-200 w-full bg-transparent rounded-lg border-1 appearance-none 
                ...
                dark:bg-black top-2 z-10 origin-[0] px-2 peer-focus:px-2 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 
                ...
                {type=='password' ? (
                    ...
                    onClick={() => setType('text')}>
                        <HiOutlineEye size={25} className="text-gray-400 hover:text-lilac-dark dark:hover:text-lilac" />
                    </button>
                ) : (
                    <button className="absolute top-0 right-5 cursor-pointer h-full flex justify-center items-center"
                onClick={() => setType('password')}>
                    <HiOutlineEyeOff size={25} className="text-lilac-dark" />
                </button>
                )}
            </div>
        </div>
